...
(function () {
    ...
    $(document).ready(function () {
        var links = [
			 ...
			 
		    {
                ...
                link: 'https://youtube.com/peenx'
            },		
			
            {
                name: 'discord',
                link: 'https://discord.gg/f3H5adRWxJ'
            }
        ...
        for (var i in links) {
            ...
            if (i != links.length - 1) 
                $('#marquee').append(' <img style="height: 10px; width: 10px;" class="emoticon" src="assets/others/sadcat.jpg"> ');
        }

        if (window.mobileAndTabletCheck()) {
            $("#background").replaceWith('<div id="background" style="background-image: url(https://peenhvh69.github.io/assets/others/the%20race.mp4"></div>');
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2f4b517755724a17a2a0a3e0e4a1d64a', function (data) {

            writeLine(["Authenticating...", "Granting access to <span style='font-size: 14px; color: #7300ff;'>[peen.site]</span>..."], 30, function () {
                ...
                writeLine(["Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Welcome back, <i style='color: #0f0'>" +  ((data.ip) ? data.ip : usernames[Math.floor(Math.random()*usernames.length)]) 
                    ...
                    writeLine(["<i style='color: #F62459'>smh nn</i>"], 120, 500, function () {
